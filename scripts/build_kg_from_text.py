...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build a Neo4j knowledge graph from a text file.")
    parser.add_argument(
        "--input",
        default="data/sample_petrochemical.txt",
        help="UTF-8 text file to ingest.",
    )
